...
@CheckReturnValue
@Immutable
final class ImmutableConfig implements ArrowRules.ArrowFilterRule.Config {
    ...
    private ImmutableConfig() {
        this.initShim = new ImmutableConfig.InitShim();
    ...
    private ImmutableConfig(RelBuilderFactory relBuilderFactory, @Nullable String description, RelRule.OperandTransform operandSupplier) {
        this.initShim = new ImmutableConfig.InitShim();
    ...
    private RelBuilderFactory relBuilderFactoryInitialize() {
        return ArrowRules.ArrowFilterRule.Config.super.relBuilderFactory();
    }
    ...
    public static ImmutableConfig of() {
        return INSTANCE;
    }
